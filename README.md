...
***This is a fork of the Empire 3.0 Beta implementing Python 3 support. The agent code remains Py2 at this time, and core Empire has not yet been tested for backwards compatibility with Python 2.***
